...
\author{Abdul~Muqtadir, Rehan, Haroon, and Anas \\
\IEEEmembership{Department of Avionics Engineering} \\
College of Aeronautical Engineering (CAE), National University of Sciences and Technology (NUST), Risalpur, Pakistan \\
}

\markboth{IEEE Antennas and Wireless Propagation Technical Report, August~2026}%
{Muqtadir \MakeLowercase{\textit{et al.}}: Evolutionary Multi-Model & Conformal Vivaldi Array}
...
\centering
\begin{tabularx}{\textwidth}{@{}l p{2.8cm} p{2.2cm} X p{2.3cm} X@{}}
\toprule
...
Model 1 & Rogers RT5880 ($\varepsilon_r=2.2$) & Balanced Microstrip & Double-sided, large mouth aperture & $4.5 - 12.0\text{ GHz}$ & Large size ($60 \times 120\text{ mm}^2$), high reflection at 18 GHz \\ \addlinespace
Model 2 & Rogers RT6035HTC ($\varepsilon_r=3.6$) & CPW ($33.7\,\Omega$) & $M_w=4.0\text{ mm}$, $g=0.5\text{ mm}$ & Discontinuous & Baseline $Z_0$ mismatch, ripples up to $-3\text{ dB}$ \\ \addlinespace
Model 3 & Rogers RT6035HTC ($\varepsilon_r=3.6$) & CPW + Cavity Hole & Circular hole at $P_2$, initial side slits & Resonant dips & $1.25\text{ GHz}$ periodic standing-wave phase cancellation \\ \addlinespace
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\columnwidth]{test22.jpg}
